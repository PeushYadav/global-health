 ...
 * 
 * Provides video calling interface for patients with:
 * - WebRTC peer-to-peer video/audio
 * - Real-time text chat via DataChannel  
 * - Patient-friendly themed UI
 * - Easy connection to doctor calls
 */
...
export default function PatientVideoCall() {
  ...
  const roomId = searchParams.get('roomId') || searchParams.get('id') || `patient_call_${Date.now()}`;
  ...
  const initializeCall = useCallback(async () => {
    try {
      ...
      socketRef.current.on('connect', () => {
        ...
        setIsConnected(true);
        setConnectionStatus('Connected - Joining call...');
  ...
  // Handle user joined (patient perspective)
  const handleUserJoined = () => {
    console.log('Doctor is ready for call');
    setConnectionStatus('Doctor connected - Call ready');
  };
  ...
  const handleUserLeft = () => {
    ...
    setConnectionStatus('Doctor disconnected');
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          <div className="text-red-600 text-xl mb-4">⚠️ No Room ID</div>
          <p className="text-gray-600 mb-4">No video call room specified.</p>
          <button 
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="bg-gray-800 p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            <h1 className="text-xl font-bold">Patient Video Call</h1>
            ...
            {!isCallActive && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-300">Connecting to your doctor...</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.length === 0 ? (
              ...
              messages.map((msg, index) => (
                <div key={index} className={`${msg.sender === 'Patient' ? 'text-right' : 'text-left'}`}>
